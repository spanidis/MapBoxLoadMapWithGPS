...
public class MainActivityWithNavigation extends AppCompatActivity {
    ...
    private final ActivityResultLauncher<String> activityResultLauncher = registerForActivityResult(new ActivityResultContracts.RequestPermission(), new ActivityResultCallback<Boolean>() {
        ...
        public void onActivityResult(Boolean granted) {
            if (granted) {
                ...
                Toast.makeText(MainActivityWithNavigation.this, "Location permission GRANTED.", Toast.LENGTH_SHORT).show();
            } else {
                // Location permissions not granted, handle accordingly
                Toast.makeText(MainActivityWithNavigation.this, "Location permission DENIED.", Toast.LENGTH_SHORT).show();
            }
        }
    });
    ...
    private final OnIndicatorPositionChangedListener onIndicatorPositionChangedListener = new OnIndicatorPositionChangedListener() {
        ...
        public void onIndicatorPositionChanged(@NonNull Point point) {
            ...
            Toast.makeText(MainActivityWithNavigation.this, "POINT: "+point.toString(), Toast.LENGTH_SHORT).show();
        }
    };
